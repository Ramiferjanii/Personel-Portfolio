...
const MenuItem: React.FC<MenuItemProps> = ({ link, label, text, icon }) => {
  ...
  const repeatedMarqueeContent = React.useMemo(() => {
    return Array.from({ length: 4 }).map((_, idx) => (
      <React.Fragment key={idx}>
        <span className="text-[#060010] uppercase font-normal text-[4vh] leading-[1.2] p-[1vh_1vw_0] whitespace-nowrap">{text}</span>
        <div className="w-[200px] h-[7vh] my-[2em] mx-[2vw] p-[1em_0] rounded-[50px] flex items-center justify-center">
          <div className="text-[#060010] text-[3vh]">
            {icon}
          </div>
        </div>
      </React.Fragment>
